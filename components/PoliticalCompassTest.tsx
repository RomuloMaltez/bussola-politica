...
const propositions: Proposition[] = [
  ...
  { id: 31, text: 'Países em desenvolvimento devem priorizar a erradicação da pobreza sobre a proteção ambiental.', cluster: 'Meio Ambiente, Energia e Sustentabilidade', axis: 'Econômico', direction: +1, explanation: 'Refere-se ao debate sobre a compatibilidade entre metas de crescimento econômico acelerado e restrições ambientais em países em desenvolvimento.' },
  ...
  { id: 46, text: 'Arte e cultura financiadas pelo público devem respeitar os valores tradicionais da sociedade.', cluster: 'Direitos, Cultura e Ordem Social', axis: 'Social', direction: +1, explanation: 'Debate se há critérios de conteúdo que devem ser aplicados à arte financiada com recursos públicos.' },
