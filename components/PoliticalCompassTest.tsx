...
const propositions: Proposition[] = [
  ...
  { id: 3, text: 'A legislação trabalhista deve priorizar a flexibilidade para incentivar contratações, em vez de enfatizar a segurança do trabalhador.', cluster: 'Economia, Trabalho e Estado', axis: 'Econômico', direction: +1, explanation: 'Significa reduzir regras e regulamentações sobre contratação, demissão e condições de trabalho.' },
  ...
  { id: 9, text: 'A política econômica deve priorizar o controle da inflação sobre a redução do desemprego no curto prazo.', cluster: 'Economia, Trabalho e Estado', axis: 'Econômico', direction: +1, explanation: 'Discute a prioridade da política econômica: focar em manter os preços estáveis, mesmo que as medidas para isso possam causar desemprego, ou priorizar o pleno emprego.' },
