...
const propositions: Proposition[] = [
  ...
  { id: 2, text: 'Empresas estatais em setores estratégicos, como energia e recursos naturais, não deveriam ser privatizadas.', cluster: 'Economia, Trabalho e Estado', axis: 'Econômico', direction: -1, explanation: 'São empresas controladas pelo governo. Privatização é a transferência desse controle para o setor privado.' },
  { id: 3, text: 'A legislação trabalhista deve priorizar a flexibilidade para incentivar contratações.', cluster: 'Economia, Trabalho e Estado', axis: 'Econômico', direction: +1, explanation: 'Significa reduzir regras e regulamentações sobre contratação, demissão e condições de trabalho.' },
  ...
  { id: 5, text: 'O Estado deve reduzir drasticamente os gastos públicos em todos os setores', cluster: 'Economia, Trabalho e Estado', axis: 'Econômico', direction: +1, explanation: 'Implica em o governo diminuir suas despesas em diversas áreas, incluindo serviços públicos.' },
  { id: 6, text: 'Os impostos devem ser progressivos, com quem ganha mais pagando uma porcentagem maior.', cluster: 'Economia, Trabalho e Estado', axis: 'Econômico', direction: -1, explanation: 'É um sistema tributário onde a alíquota (porcentagem) do imposto aumenta à medida que a renda ou o patrimônio da pessoa ou empresa aumenta.' },
  ...
  { id: 9, text: 'A política econômica deve priorizar primeiro o controle da inflação e depois o controle do desemprego.', cluster: 'Economia, Trabalho e Estado', axis: 'Econômico', direction: +1, explanation: 'Discute a prioridade da política econômica: focar em manter os preços estáveis, mesmo que as medidas para isso possam causar desemprego, ou priorizar o pleno emprego.' },
  ...
  { id: 12, text: 'O livre mercado é mais benéfico do que prejudicial aos trabalhadores e à indústria nacional.', cluster: 'Economia, Trabalho e Estado', axis: 'Econômico', direction: -1, explanation: 'Refere-se à eliminação de barreiras comerciais (como tarifas de importação) entre países, permitindo circulação irrestrita de produtos.' },
  { id: 13, text: 'A propriedade privada é um direito absoluto e não deve ser relativizada por conceitos como "função social".', cluster: 'Economia, Trabalho e Estado', axis: 'Econômico', direction: +1, explanation: 'Direitos absolutos são aqueles que valem contra qualquer pessoa e não podem ser desrespeitados nem limitados de nenhuma forma. "Função social" é um princípio que estabelece que o uso da propriedade privada deve atender não apenas aos interesses do dono, mas também ao do Governo.' },
  ...
  { id: 25, text: 'A liberdade de expressão online deve ser absoluta, incluindo discursos de ódio ou teorias da conspiração.', cluster: 'Tecnologia, Privacidade e Sociedade Digital', axis: 'Social', direction: -1, explanation: 'Debate se a liberdade de expressão na internet deve ter limites legais ou ser irrestrita.' },
  ...
  { id: 31, text: 'Países em desenvolvimento devem priorizar a erradicação da pobreza em vez de proteção ambiental.', cluster: 'Meio Ambiente, Energia e Sustentabilidade', axis: 'Econômico', direction: +1, explanation: 'Refere-se ao debate sobre a compatibilidade entre metas de crescimento econômico acelerado e restrições ambientais em países em desenvolvimento.' },
  ...
  { id: 33, text: 'Um imposto sobre o carbono deve ser implementado para combater as mudanças climáticas.', cluster: 'Meio Ambiente, Energia e Sustentabilidade', axis: 'Econômico', direction: -1, explanation: 'É um tributo cobrado sobre a emissão de gases de efeito estufa.' },
  ...
  { id: 35, text: 'As leis ambientais atuais no Brasil devem ser flexibilizadas para facilitar o desenvolvimento.', cluster: 'Meio Ambiente, Energia e Sustentabilidade', axis: 'Econômico', direction: +1, explanation: 'Significa reduzir o rigor das regras de proteção ao meio ambiente aplicadas a projetos de desenvolvimento e atividades econômicas.' },

  // Cluster 4: Direitos, Cultura e Ordem Social
  { id: 36, text: 'O porte de armas por cidadãos, com regras rígidas para obtenção do porte, deveria ser um direito garantido para a autodefesa.', cluster: 'Direitos, Cultura e Ordem Social', axis: 'Social', direction: -1, explanation: 'Refere-se ao direito de um cidadão comum possuir e carregar armas de fogo para sua própria defesa.' },
  ...
  { id: 45, text: 'A polícia deve ter mais autonomia e menos supervisão externa para combater o crime.', cluster: 'Direitos, Cultura e Ordem Social', axis: 'Social', direction: +1, explanation: 'É a ideia de que as forças policiais deveriam ter mais liberdade para agir e tomar decisões sem supervisão de órgãos de controle externos.' },
  { id: 46, text: 'Arte e cultura financiadas pelo governo devem respeitar os valores tradicionais da sociedade.', cluster: 'Direitos, Cultura e Ordem Social', axis: 'Social', direction: +1, explanation: 'Debate se há critérios de conteúdo que devem ser aplicados à arte financiada com recursos públicos.' },
  ...
  { id: 48, text: 'A maioridade penal deve ser reduzida para combater a criminalidade entre jovens.', cluster: 'Direitos, Cultura e Ordem Social', axis: 'Social', direction: +1, explanation: 'É a proposta de diminuir a idade a partir da qual um adolescente pode ser julgado e punido como um adulto por seus crimes.' },
  ...
  { id: 57, text: 'O país deve fornecer ajuda humanitária e financeira a outros, mesmo em tempos de dificuldade econômica interna.', cluster: 'Soberania, Geopolítica e Relações Internacionais', axis: 'Econômico', direction: -1, explanation: 'Refere-se ao envio de recursos financeiros ou materiais de um país para outras nações em situação de crise.' },
  ...
  { id: 65, text: 'Problemas globais como pandemias, crises climáticas e terrorismo devem ser resolvidos por meio de cooperação internacional.', cluster: 'Soberania, Geopolítica e Relações Internacionais', axis: 'Social', direction: -1, explanation: 'É a visão de que os maiores desafios do mundo só podem ser resolvidos com a união e a colaboração de todos os países.' },
];
